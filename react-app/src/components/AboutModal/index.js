...
function AboutModal(){
    ...
    return(
        <div className="about-section">
            ...
            <img id="about-logo" src="https://i.imgur.com/DK2auRU.png"/>
            <div className="content">
                <img id="profile-image" src="https://i.imgur.com/3MRH2wb.jpg"/>
            ...
            <a href="https://github.com/atias6051" target="_blank"><i class="fa-brands fa-github"></i><span>GitHub</span></a>
            <a href="https://www.linkedin.com/in/gal-atias/" target="_blank"><i class="fa-brands fa-linkedin"></i><span>LinkedIn</span></a>
            <a href="https://www.linkedin.com/in/gal-atias/" target="_blank"><i class="fa-regular fa-id-card"></i><span>Portfolio</span></a>
            </div>
        </div>
    )
}
